...
/**
 * Backing class for the Your Movie data form.
 * Requirements:
 * <ul>
...
public class YourMovie {
    ...
    public YourMovie(String name, String password, GradeLevel level, Experience gpa, List<Hobby> hobbies, List<Major> majors) {
        this.name = name;
    ...
    public List<ValidationError> validate() {
        ...
        } else if (Experience.findGPA(gpa) == null) {
