...
public class Major {
     ...
     */
    public static Map<String, Boolean> makeMajorMap(YourMovie student) {
    ...
    static {
        allMajors.add(new Major(1L, "BA/BSC/BCA"));
        allMajors.add(new Major(2L, "MA/MSc/MCA"));
        allMajors.add(new Major(3L, "BTec/B.E/MTec"));
        allMajors.add(new Major(4L, "Others"));
    }
